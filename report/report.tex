...
Table~\ref{tab:ripenessMatrix} showed that we were able to distinguish between unripe and overripe bananas successfully. Though, the system had difficulty in distinguishing ripe bananas from the other two classes. Overall, our accuracy on classifying banana ripeness was 90.2\% and this was an improvement on the work by~\citet{saad2009recognizing} over a much larger data set. 
